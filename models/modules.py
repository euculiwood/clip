...
class CrossAttentionHead(nn.Module):
    ...
    :param model_embed_dim: dimensionality of the models tensors
...
class SelfAttention(nn.Module):
    ...
    :param embedding_dim: total dimensionality of the models (equal to
        `head_size * num_heads`)
...
class TransformerBlock(nn.Module):
    ...
    :param embedding_dim: total dimensionality of the self-attention models (equal to
        `head_size * num_heads`)
...
class TiedLinear(nn.Module):
    ...
    show up in module summaries, which can help to make the structure of the models more
    transparent.
...
def _init_by_depth(module: nn.Module, depth: int) -> None:
    """Initialize the weights of a module based on the depth of the models."""
